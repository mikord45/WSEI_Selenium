    ...
    public class SeleniumCSharpTutorial04
    {
        ...
        public void Test1(String urlName)
        {
            ...
            catch (Exception e)
            {
                ...
                string projectRootDirectory = Directory.GetParent(currentDirectory).Parent.FullName;
                string screenshotDirectory = Path.Combine(projectRootDirectory, "Screenshots");
                string filename = "Screenshot1.jpeg";
